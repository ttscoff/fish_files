...
function git_fzf_key_bindings -d "Set custom key bindings for git+fzf"
    bind -M insert ctrl-g,ctrl-f __git_fzf_git_status
    bind -M insert ctrl-g,ctrl-b __git_fzf_git_branch
    bind -M insert ctrl-g,ctrl-t __git_fzf_git_tag
    bind -M insert ctrl-g,ctrl-h __git_fzf_git_log
    bind -M insert ctrl-g,ctrl-r __git_fzf_git_remote
    bind -M insert ctrl-g,ctrl-a __git_fzf_stage
    bind -M insert ctrl-g,ctrl-e __git_fzf_unstage
end
