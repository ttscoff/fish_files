function install_vscode_prompts -d 'Install VS Code prompt files from dotfiles to .github/prompts, with optional filtering.'
    set filter ""
    ...
    for src in ~/dotfiles/github/prompts/*
