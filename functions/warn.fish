function warn -d "Echo log message to STDERR"
    ...
    if set -q _flag_help
        warn "Output log message to STDERR"
        warn "Usage: warn [-e|--error | -w|--warn | -i|--info] <message>"
        warn "Options:"
        warn "  -e, --error   Error level message"
        warn "  -w, --warn    Warning level message"
        warn "  -i, --info    Info level message"
        return
    end
